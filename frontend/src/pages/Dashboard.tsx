          ...
          >
            ...
            <div style={{ padding: '1.75rem' }}>
              ...
              <button
                ...
                style={{
                  width: '100%', padding: '1rem', borderRadius: '16px', fontSize: '1rem',
        ...
        <main className="main-content" style={{ maxWidth: '1200px', width: '100%', margin: '0 auto', padding: '3rem 2rem' }}>
          ...
          {!isProfileComplete && (
            <div style={{
              ...
              <div style={{ flex: 1, minWidth: '280px', backgroundColor: 'rgba(255,255,255,0.7)', border: '1px dashed rgba(128,10,63,0.1)', borderRadius: '20px', padding: '2rem', textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', minHeight: '220px' }}>
